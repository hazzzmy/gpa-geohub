...
-- CreateIndex
CREATE UNIQUE INDEX "user_user_groups_userId_userGroupId_key" ON "public"."user_user_groups"("userId", "userGroupId");
...
-- AddForeignKey
ALTER TABLE "public"."user_groups" ADD CONSTRAINT "user_groups_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "public"."organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."user_user_groups" ADD CONSTRAINT "user_user_groups_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."user_user_groups" ADD CONSTRAINT "user_user_groups_userGroupId_fkey" FOREIGN KEY ("userGroupId") REFERENCES "public"."user_groups"("id") ON DELETE CASCADE ON UPDATE CASCADE;
