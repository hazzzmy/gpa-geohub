...
export async function GET(_request: NextRequest) {
  try {
    ...
    console.log("🔍 Land Development All Task Types Data:", JSON.stringify(data, null, 2));
    ...
    console.error("❌ Land Development All Task Types API error:", error);
    return NextResponse.json(
      {
        success: false,
        error:
          error instanceof Error ? error.message : "Failed to fetch land development statistics",
      },
      { status: 500 },
    );
  }
